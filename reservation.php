          ...
          ?>
            ...
            <form action="reservationManager.php" method="POST">
              <div class="row">
                <div class="col-md-10 col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="AccountName" class="form-control" placeholder="Enter Name" maxlength="30" required>
                  </div>
                </div>
                <div class="col-md-10 col-lg-6">
                  <div class="form-group">
                    <label for="AccountPhoneNumber">Phone Number: <span style="color:red" id="phone_error_msg"></span></label>
                    <input type="text" name="AccountPhoneNumber" class="form-control" id="phoneNumber" placeholder="Enter Phone Number" pattern=".{10,11}" maxlength="11" required>
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label for="AccountEmail">Email:</label>
                <input type="email" class="form-control" name="AccountEmail" placeholder="Enter Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3}" maxlength="30" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="ReservationPax" id="pax" required>
