...
$sql = "SELECT *, SUM(TotalCost) AS Sales FROM orders WHERE YEAR(OrderDate) = " . $year . " AND RestaurantID = " . $_SESSION['user']['resid'] . " GROUP BY MONTH(OrderDate)";
...
<body>
    ...
    <section class="slider-hero hero-slider  hero-style-1  ">
        ...
        <section class="section">
            <div class="container">
                <section>
                    <label>Yearly Report <span style="color:red" class="year_error_msg"></span></label>
                ...
                <div id="table">
                    <table cellpadding="10" cellspacing="0" width="100%">
                        <?php
                        $sql2 = "SELECT *, SUM(TotalCost) AS Sales FROM orders WHERE YEAR(OrderDate) = " . $year . " AND RestaurantID = " . $_SESSION['user']['resid'] . " GROUP BY MONTH(OrderDate)";
                        ?>
                        <thead>
                            <tr>
