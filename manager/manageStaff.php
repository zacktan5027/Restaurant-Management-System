    ...
    <section class="slider-hero hero-slider  hero-style-1  ">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <h1 class="text-capitalize mb-4 font-lg text-white">Staff</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section">
            <div style="margin: auto;width:80%">
                ...
                <button class="btn btn-main float-right" onclick="document.getElementById('addStaff').style.display='block'"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Staff</button>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table text-center table-cart">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM staff NATURAL JOIN restaurant WHERE RestaurantID='" . $_SESSION['user']['resid'] . "' AND StaffPosition='Staff' $where";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-main" onclick="document.getElementById('editStaff<?php echo $res['StaffID']; ?>').style.display='block'">Edit</button>
                                                    <?php
                                                    if ($res['active']) {
                                                    ?>
                                                        <button class="btn btn-main" onclick="document.getElementById('deactiveStaff<?php echo $res['StaffID']; ?>').style.display='block'">Deactive</button>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <button class="btn btn-dark" onclick="document.getElementById('deactiveStaff<?php echo $res['StaffID']; ?>').style.display='block'">Active</button>
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
