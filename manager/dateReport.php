...
$sql = "SELECT *, SUM(TotalCost) AS Sales FROM orders NATURAL JOIN orderdetail NATURAL JOIN dish WHERE OrderDate = '" . $date . "' AND RestaurantID = " . $_SESSION['user']['resid'] . " GROUP BY DishID ";
            ...
            <div class="container">
                ...
                <div id="table">
                    <table cellpadding="10" cellspacing="0" width="100%">
                        ...
                        <?php
                        $sql2 = "SELECT *, SUM(TotalCost) AS Sales FROM orders NATURAL JOIN orderdetail NATURAL JOIN dish WHERE OrderDate = '" . $date . "' AND RestaurantID = " . $_SESSION['user']['resid'] . " GROUP BY DishID ";
