                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="manageDish.php">Dish</a></li>
                            <li><a class="dropdown-item" href="manageDishCategory.php">Dish Category</a></li>
                            <li><a class="dropdown-item" href="manageRestaurant.php">Restaurant</a></li>
                            <li><a class="dropdown-item" href="manageManager.php">Manager</a></li>
                        </ul>
                    </li>
