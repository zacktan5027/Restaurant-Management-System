...
<body>
    ...
    <section class="slider-hero hero-slider  hero-style-1  ">
        ...
        <section class="section">
            <div class="container">
                <select id="resList" class="btn btn-default" style="width: 100%;border:solid 1px #f5f5f5; background-color:#f5f5f5;font-size:16px">
                    <option value="0">Please choose a restaurant</option>
                    <?php if ($_GET['restaurant'] == "all") { ?>
                        <option value="all" selected>All restaurant</option>
                    <?php
                    } else {
                    ?>
                    ...
                    while ($row = $query->fetch_array()) {
                        ...
                        $selected = ($catid == $row['RestaurantID']) ? " selected" : "";
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <form action="dailyReport.php?type=table" method="POST">
                                                        ...
                                                        ?>
                                                        <input class="resID" type="hidden" name="restaurantID" value="<?= $_GET['restaurant'] ?>">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <form action="monthlyReport.php" method="POST">
                                                        ...
                                                        <input class="btn btn-main float-right" type="submit" name="month" value="Generate Report" />
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div class="form-group">
                                                    <form action="yearlyReport.php" method="POST">
                                                        <form class="row">
                                                            ...
                                                            <input class="btn btn-main float-right" type="submit" name="year" value="Generate Report" />
                                                        </form>
                                                </div>
                                            </td>
                                        </tr>
