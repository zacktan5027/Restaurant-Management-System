...
if ($id == "all") {
    ...
    $sql = "SELECT *, SUM(TotalCost) AS Sales FROM orders NATURAL JOIN orderdetail NATURAL JOIN dish NATURAL JOIN restaurant WHERE OrderDate = '" . $date . "' GROUP BY RestaurantID ";
    ...
    $sql = "SELECT *, SUM(TotalCost) AS Sales FROM orders NATURAL JOIN orderdetail NATURAL JOIN dish WHERE OrderDate = '" . $date . "' AND RestaurantID = " . $id . " GROUP BY DishID ";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <h1 class="text-capitalize mb-4 font-lg text-white">Date Report</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="table">
                    <table cellpadding="10" cellspacing="0" width="100%">
                        ...
                        if ($_POST['restaurantID'] == 'all') {
                            $sql2 = "SELECT *, SUM(TotalCost) AS Sales FROM orders NATURAL JOIN orderdetail NATURAL JOIN dish NATURAL JOIN restaurant WHERE OrderDate = '" . $date . "'GROUP BY RestaurantID ";
                        ...
                        ?>
                            ...
                            $sql2 = "SELECT *, SUM(TotalCost) AS Sales FROM orders NATURAL JOIN orderdetail NATURAL JOIN dish NATURAL JOIN restaurant WHERE OrderDate = '" . $date . "' AND RestaurantID = " . $id . " GROUP BY RestaurantID ";
