						...
						<div class="container">
							<div class="row">
								<div class="col-lg-7">
									...
									<a href="menu.php" class="btn btn-main mr-3" data-swiper-parallax="500">View Menu</a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="col-12 text-center mb-5">
				<div class="btn-group btn-group-toggle" data-toggle="buttons">
					...
					<?php $query = $conn->query("select * from category where activeCategory=1");
			...
			<div class="row shuffle-wrapper food-gallery">
				<?php foreach ($dishes as $key => $dish) {  ?>
					<div class="col-lg-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;<?= $dish['categoryid'] ?>&quot;]" height=200px>
						<div class="menu-item position-relative " height=200px>
							<a href="dish.php?id=<?= $dish['dishid'] ?>">
								<div class="d-flex align-items-center">
									<img src="upload/<?= $dish['photo'] ?>" alt="" style="width:50px;height:110px">
									<div>
										<h4><?= $dish['name'] ?> - <span>RM <?= number_format($dish['price'], 2) ?></span></h4>
										<p><?php if (strlen($dish['des']) > 80)
			...
			<div class="row">
				<div class="col-lg-12 text-center mt-5">
					<a href="menu.php" class="btn btn-black ">View full menu</a>
				</div>
			</div>
		</div>
	</section>
