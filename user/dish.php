                    ...
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        ...
                        <div>
                            <div style="text-align:center">
                                ...
                                <input id="quantity" type="text" id="quantity" value="1" style="width:200px;padding:9px;text-align:center" maxlength="2" />
                                ...
                                <form method="post" action="cartManager.php?action=add">
                                    ...
                                    <input type="submit" value="Add to Cart" style="margin-top:8px" class="btn btn-main" />
                                </form>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        ...
                        <div style="text-align:center">
                            <a href="rating.php?id=<?= $dishes["dishid"] ?>" class="btn btn-main">Add your Rating</a>
