          ...
          <div class="details-form">
            ...
            <form action="payment.php" id="bookingForm" method="post">
              <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="Enter Name" name="AccountName" maxlength="30" required>
              </div>
              <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Address 1" name="AccountAddress1" maxlength="30" required>
                  </div>
                  <div class="form-group">
                    <label>Address2 <small style="color:gray">(Taman Sejati Indah)</small> </label>
                    <input type="text" class="form-control" placeholder="Enter Address 2" name="AccountAddress2" maxlength="30" required>
                  </div>
                  <div class="form-group">
                    <label>City</label>
                    <input type="text" class="form-control" placeholder="City" name="AccountCity" maxlength="30" required>
                  </div>
                </div>
                <div class="col-md-6 col-lg-6">
                  <div class="form-group">
                    <label>State</label>
                    <select class="form-control" style="margin:7px 0 25px 0" name="AccountState" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="postcode" class="form-control" name="AccountPostcode" placeholder="Postcode" pattern=".{5,5}" maxlength="5" style="margin:10px 0 8px 0" required>
                  </div>
                  <div class="form-group">
