      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="text-center">
            <h1 class="text-capitalize mb-4 font-lg text-white" id="main">Cart Page</h1>
          </div>
        </div>
      </div>
    </div>
                          ...
                          <td>
                            <div style='display: flex; flex-direction: row;align-items:baseline'>
                              ...
                              <form class='myForm' action='cartManager.php?action=change' method='post'>
                                ...
                                <input type='text' class="quantity form-control" name="quantities" value='<?= $value["quantity"] ?>' style="height:100% " maxlength=2 required>
                              </form>
